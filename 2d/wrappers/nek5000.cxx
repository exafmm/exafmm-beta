...
extern "C" void fmm_init_(double & eps2, int & ncrit, int & nworkers,
...
extern "C" void fmm_partition_(int & nb, double * xb, double * yb, double * vb,
			       int & nv, double * xv, double * yv, double * vv) {
...
extern "C" void fmm_b2b_(double * vi, double * vb, int & verbose) {
...
extern "C" void fmm_v2b_(double * vb, double * vv, int & verbose) {
  args->verbose = verbose;
  args->numBodies = bbodies.size();
  log_initialize();
  for (B_iter B=bbodies.begin(); B!=bbodies.end(); B++) {
...
extern "C" void fmm_b2v_(double * vv, double * vb, int & verbose) {
  args->verbose = verbose;
...
extern "C" void fmm_v2v_(double * vi, double * vv, int & verbose) {
  args->verbose = verbose;
  args->numBodies = vbodies.size();
  log_initialize();
  for (B_iter B=vbodies.begin(); B!=vbodies.end(); B++) {
...
extern "C" void fmm_(int & ni, double * xi, double * yi, double * vi,
...
extern "C" void direct_(int & ni, double * xi, double * yi, double * vi,
			int & nj, double * xj, double * yj, double * vj) {
  Bodies bodies(ni);
  for (B_iter B=bodies.begin(); B!=bodies.end(); B++) {
    int i = B-bodies.begin();
