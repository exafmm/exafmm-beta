...
int main(int argc, char ** argv) {
  ...
  case 'L':                                                     // Laplace equation
    fmm<LaplaceSphericalCPU<Pmax> >(args);                      //  Call Laplace Spherical kernel
    break;                                                      // Break Spherical basis
  case 'H':                                                     // Helmholtz equation
    fmm<HelmholtzSphericalCPU<2*Pmax> >(args);                  //  Call Helmholtz Spherical kernel
    break;                                                      // Break Helmholtz equation
  case 'B':                                                     // Biot-Savart equation
    fmm<BiotSavartSphericalCPU<Pmax> >(args);                   //  Call Biot-Savart Spherical kernel
